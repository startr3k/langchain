"""Add SEC filing sentiment features to the 5-year dataset (no GDELT).
...
OUTPUT_CSV = "training_data_5y_with_sec_sentiment.csv"
CHECKPOINT_CSV = "training_data_5y_sec_sentiment_checkpoint.csv"
PROGRESS_FILE = "sec_only_progress.txt"
